...
public:
	...
	void DrawOutline(ColorRGBA Color, int Corners, float Rounding) const; // EClient
	void DrawSpecificOutline(ColorRGBA Color, int Corners, int Sides, float Rounding) const; // EClient
	/**
