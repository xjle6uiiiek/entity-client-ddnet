...
MACRO_CONFIG_INT(ClDummyCountry, dummy_country, -1, -1000, 1000, CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_INSENSITIVE, "Country of the dummy (ISO 3166-1 numeric)")
...
MACRO_CONFIG_INT(PlayerCountry, player_country, -1, -1000, 1000, CFGFLAG_SAVE | CFGFLAG_CLIENT | CFGFLAG_INSENSITIVE, "Country of the player (ISO 3166-1 numeric)")
...
MACRO_CONFIG_INT(SvEditorSession, sv_editor_session, 0, 0, 1, CFGFLAG_SERVER, "Enable collaborative level editing session on the server")
